            ...
            <div class="page-title-box d-flex flex-column mt-3">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{url('/tutorials')}}">Tutorials</a></li>
    ...
    <div class="row">
        ...
        <div class="col-2">
            ...
            <div class="card w-100">
                <div class="card-body">
                    <h4 class="card-title fw-bolder mb-0 mt-0">Recent Tutorials</h4>
                </div>
                <ul class="text-primary">
               @foreach(DB::table('blogs')->where('type', 'Tutorial')->where('is_deleted', 0)->where('id', '!=', $blog->id)->orderBy('id', 'desc')->get() as $b)
               <li class="" style="cursor:pointer;" onclick="window.location.href='{{url('/tutorial/'.$b->id)}}'">{{$b->blog_name}}</li>
               @endforeach
                </ul>
            </div>
