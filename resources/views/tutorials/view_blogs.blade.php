...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="mt-2" method="GET" action="{{url('/tutorials/view')}}">
                        <div class="row">
                                ...
                                <tbody>
                                    ...
                                    <tr class="align-middle">
                                        <td class="text-nowrap">
                                            <a href="{{url('/tutorials/play/'.$blog->id)}}">Play</a>
                                        </td>
                                        <td class="text-nowrap">
                                            {{$blog->blog_name}}
                                        </td>
                                        <td class="text-end">
                                            <div>
                                                <a class="btn p-0" href="{{url('/tutorial/edit/'.$blog->id)}}" data-bs-toggle="tooltip"
