...
<div class="page-content">
    ...
    <div class="card mb-3">
        <div class="card-body ">
            <h4 class="card-title mb-3">Add New Tutorial</h4>


            <form class="save-form " method="POST" action="{{ url('/tutorial/save') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control @error('media') is-invalid @enderror" accept="jpg,jpeg,png,gif,webp,svg,mp4,avi,mkv,mov" id="media" name="media">
                    @error('media')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('iframe') is-invalid @enderror" name="iframe" rows="10">{{ old('iframe') }}</textarea>
                    @error('iframe')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
