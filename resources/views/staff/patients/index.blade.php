                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <div class="col-12 position-relative">
                                    <input class="form-control form-control-sm pickr ps-4" name="date" id="CRMDateRange"
                                        value="{{ @$_GET['date'] }}" placeholder="Y-m-d to Y-m-d" type="text" style="border: 1px solid #aaa;"
...
<script src="{{ asset('public/assets/customjs/staff/patients.js') }}?v={{ time() }}"></script>
<script>
