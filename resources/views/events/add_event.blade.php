...
<div class="page-content">
    ...
    <div class="card mb-3">
        <div class="card-body ">
            ...
            <form class="save-form " method="POST" action="{{ url('/events/save') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    ...
                    <input class="form-control @error('event_name') is-invalid @enderror" id="event_name" type="text"
                        value="{{ old('event_name') }}" placeholder="Event Name" name="event_name">
                    @error('event_name')
                ...
                <div class="mb-3">
                    ...
                    id="date" type="text"
                        value="{{ old('date') }}" placeholder="d/m/Y" name="date">
                    @error('date')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input class="form-control @error('link') is-invalid @enderror" id="link" type="text"
                        value="{{ old('link') }}" placeholder="https://" name="link">
                    @error('link')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
