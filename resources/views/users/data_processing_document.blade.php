...
<link rel="stylesheet" href="{{asset('public')}}/assets/signaturepad/docs/css/signature-pad.css">
<style>
    .wrapper {
        width: 100%;
        height: 100vh;
            ...
            <div class="page-title-box d-flex flex-column mt-3">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{url('/contracts/data-processing-documents/view')}}">Doctors</a></li>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                        <div >
                            ...
                            <img style="width: 45%;height: 10.875vh;" src="{{$doctor->data_processing_document_signatures}}">
                            @endif
                            @endif
                    ...
                    <div class="col-md-6">
                        <div >
                            <img style="width: 45%;height: 10.875vh;" src="{{asset('public')}}/assets/secret-logo.png">
...
@if(Auth::user()->role == 'doctor')
<script src="{{asset('public')}}/assets/signaturepad/docs/js/signature_pad.umd.js"></script>
<script src="{{asset('public')}}/assets/signaturepad/docs/js/app.js"></script>
<script>
