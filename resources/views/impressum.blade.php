...
<body>
    ...
    <main class="main" id="top">
        ...
        <section class="py-3 bg-light shadow-sm">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-3 col-sm-auto my-1 my-sm-3 px-card"><a href="{{ url('/home') }}"><img
                                class="landing-cta-img" height="40"
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7 col-xxl-6">
                        <h1 class="fs-2 fs-sm-4 fs-md-5">Impressum</h1>
                    </div>
                </div>
                <div class="row flex-center mt-2">
                    <div class="col-md col-xxl-6 col-lg-8 col-xl-7 mt-4 mt-md-0">
                        <p><strong>Firmenname: </strong>Al-Secret</p>
                        <p><span
                                style="font-weight: bolder; letter-spacing: 0.1px; color: var( --e-global-color-text ); font-family: var( --e-global-typography-text-font-family ), Sans-serif; font-size: 0.8125rem;">Firmenbuchnummer:&nbsp;</span>FN
                            601397 h<br><strong>Anschrift:</strong> Ringstraße 38d, 3500 Krems an der
                            Donau<br><strong>Telefon:</strong> 02732 70144<br><strong>E-Mail:
                            </strong>info@secretalign.com<br><strong>Internet:
                            </strong>https://www.secretalign.at<br><strong>Andere:</strong><br>Ort der
                            Gewerbeberechtigung<br>Ringstraße 38d, 3500 Krems an der Donau,
                            Österreich<br><strong>Berufsordnung:</strong><br>Die Tätigkeit unterliegt dem
                            Wirtschaftskammergesetz<br><strong>Aufsichtsbehörde:</strong><br>Wirtschaftskammer
                            Niederösterreich<br><strong>Sorgfaltspflicht:</strong><br>Die auf der Website
                            veröffentlichten Inhalte sind mit größter Sorgfalt recherchiert. Dennoch kann keine Gewähr
                            für die vollständige Richtigkeit übernommen werden. Alle Angaben erfolgen ohne Gewähr.
                            Al-Secret übernimmt keine Haftung für die Richtigkeit und Inhalte dieser Website,
                            insbesondere keine für eventuelle Schäden oder Konsequenzen, die durch die direkte oder
                            indirekte Nutzung der hier angebotenen Inhalte entstehen Die Inhalte dieser Webseite können
                            ohne vorherige Ankündigung geändert, entfernt oder ergänzt werden. Der Autor kann daher
                            keine Garantie für die Korrektheit,Vollständigkeit oder Qualität und letzte Aktualität der
                            bereitgestellten Informationen geben.</p>
                        <p>
                            <!-- /wp:paragraph -->
                        </p>
                    </div>
