...
<head>
  ...
  <!--    Document Title-->
  <!-- ===============================================-->
  <title>Al Secret | Dashboard &amp; Login</title>
      ...
      <div class="row min-vh-100 flex-center g-0">
        <div class="col-lg-6 col-xxl-4 py-3 position-relative">
          {{-- <img class="bg-auth-circle-shape"
            src="{{ asset('public/dashboard') }}/assets/img/icons/spot-illustrations/bg-shape.png" alt="" width="250">
          <img class="bg-auth-circle-shape-2"
            src="{{ asset('public/dashboard') }}/assets/img/icons/spot-illustrations/shape-1.png" alt="" width="150">
          --}}
    ...
    <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
        ...
        <div class="row gx-2">
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight"> <span
                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                  src="{{asset('public/dashboard')}}/assets/img/generic/falcon-mode-default.jpg" alt="" /></span><span
          ...
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span
                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                  src="{{asset('public/dashboard')}}/assets/img/generic/falcon-mode-dark.jpg" alt="" /></span><span
      ...
      <div class="d-flex justify-content-between">
        <div class="d-flex align-items-start"><img class="me-2"
            src="{{asset('public/dashboard')}}/assets/img/icons/left-arrow-from-left.svg" width="20" alt="" />
          <div class="flex-1">
            <h5 class="fs-0">RTL Mode</h5>
            <p class="fs--1 mb-0">Switch your language direction </p><a class="fs--1"
              href="{{asset('public/dashboard')}}/documentation/customization/configuration.html">RTL Documentation</a>
          </div>
        </div>
        ...
        <div class="flex-1">
          ...
          <div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" id="option-navbar-vertical" type="radio" name="navbar" value="vertical"
        ...
        <div class="row gx-2">
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent"> <img
                class="img-fluid img-prototype" src="{{asset('public/dashboard')}}/assets/img/generic/default.png"
          ...
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted"> <img
                class="img-fluid img-prototype" src="{{asset('public/dashboard')}}/assets/img/generic/inverted.png"
          ...
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card"> <img
                class="img-fluid img-prototype" src="{{asset('public/dashboard')}}/assets/img/generic/card.png"
          ...
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant"> <img
                class="img-fluid img-prototype" src="{{asset('public/dashboard')}}/assets/img/generic/vibrant.png"
                alt="" /><span class="label-text"> Vibrant</span></label>
          </div>
        </div>
      </div>
      <div class="text-center mt-5"><img class="mb-4"
          src="{{asset('public/dashboard')}}/assets/img/icons/spot-illustrations/47.png" alt="" width="120" />
