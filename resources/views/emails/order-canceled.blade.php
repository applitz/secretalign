        ...
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 20px;" width="596">
                ...
                <hr>
                <p style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #919293;">
                    If you're having trouble clicking the "View Tasks" button, copy and paste the URL below into your web browser: <a href="{{ url('/patient/edit/' . $pTreatmentPlanId.'?tab=pill-tab-div2') }}" target="_blank" style="color: #0000EE;">{{ url('/patient/edit/' . $pTreatmentPlanId.'?tab=pill-tab-div2') }}</a>
                </p>
