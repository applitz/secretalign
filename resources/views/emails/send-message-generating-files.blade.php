        ...
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 20px;" width="596">
                ...
                <a href="{{ url('/patient/case-overview/' . $pTreatmentPlanId) }}" target="_blank" style="background-color: #000000; font-size: 15px; line-height: 22px; font-family: 'Helvetica', Arial, sans-serif; font-weight: normal; text-decoration: none; padding: 12px 15px; color: #ffffff; border-radius: 5px; display: inline-block; mso-padding-alt: 0;">
                    <span style="mso-text-raise: 15pt; color: #ffffff;">View Patient Details</span>
                </a>
                <!-- End button here -->
                <br><br>
                ...
                <hr>
                <p style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #919293;">
                    If you're having trouble clicking the "View Tasks" button, copy and paste the URL below into your web browser: <a href="{{ url('/patient/case-overview/' . $pTreatmentPlanId) }}" target="_blank" style="color: #0000EE;">{{ url('/patient/case-overview/' . $pTreatmentPlanId) }}</a>
                </p>
