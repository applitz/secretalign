...
<div class="tab-pane fade {{ $baseUrl !== null && $code !== null ? 'show active' : '' }} " id="pill-tab-div2" role="tabpanel">
    ...
    <div class="mb-3 ">
        ...
        @if( Auth::user()->email == 'shubham.kakadiya02@gmail.com' || Auth::user()->email == 'wisherw064@gmail.com' || Auth::user()->email == 'izdeensbah222@gmail.com' || Auth::user()->email == 'info@zahnspangehome.at' || Auth::user()->email == 'chiragjogani21@gmail.com')
            ...
            @else
                ...
                @endphp
                <a class="btn btn-primary order-from-button"   href="javascript:void(0);" data-mode="{{ $mode }}"  data-patient-id="{{ $hashids->encode( $patient->id) }}"  id="select-from-shining3d-link" data-shining3d-user-id="{{ Auth::user()->shining3d_user_id }}" data-shining3d-access-token="{{ Auth::user()->shining3d_access_token }}" >
                    <div class="d-flex align-items-center justify-content-center">
                        <span>Import From</span>&nbsp;&nbsp;<span style="color:#004fec; font-weight: bold;">SHINING 3D</span>
                    </div>
                </a>
