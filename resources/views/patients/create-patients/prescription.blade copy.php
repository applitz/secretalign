                    ...
                    @if ($patient->is_new == '1')
                        <div class="form-group" style="align-items: center; justify-content: center; display: flex;">
                            <div id="buttons" style="justify-content: center">
                                ...
                                <input type="text" id="feature_unerupted_teeth_ids" value="" name="feature_unerupted_teeth_ids">
                                <input type="text" id="feature_extracted_teethids" value="" name="feature_extracted_teethids">
                                <input type="text" id="feature_tooth_movement_restrictions_ids" value="" name="feature_tooth_movement_restrictions_ids">
                                <input type="text" id="feature_coil_ids" value="" name="feature_coil_ids">
                                <input type="text" id="feature_pontic_ids" value="" name="feature_pontic_ids">
                                <input type="text" id="feature_bridge_ids" value="" name="feature_bridge_ids">
                                ...
                                <div class="teeth-layout-wrapper" style="max-width: 1200px; margin: 0 auto;">
                                    <div class="media img-responsive input-group" style="display:flex; flex-wrap: wrap; justify-content:center; gap:10px; padding:0.5rem 0;" id="classIIUpperArcNew">
                                        ...
                                        @if($selected)
                                            ...
                                            {{-- Outer Side Start End--}}

                                            {{-- Inner Side Start --}}
                                                @if($power_ridge_inner)
                                                    <img src="{{ asset('public/assets/tooth/png/Power-Ridge.png') }}" class="power-ridge-overlay" data-side="upper" style="position: absolute; width: 30px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 12; bottom: {{ $numberOfelementsInner == 1 ? '-25px' : ($numberOfelementsInner == 2 ? '-60px' : '-90px') }};">
                                                ...
                                                @if($precisionCutInner)
                                                    @if($id >=1 && $id <= 8)
                                                        <img src="{{ asset('public/assets/tooth/png/precisioncut-LR.png') }}" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; bottom: {{ $numberOfelementsInner == 1 ? '-25px' : ($numberOfelementsInner == 2 ? '-60px' : '-90px') }};" alt="precisioncut Inner">
                                                        @php $numberOfelementsInner++; @endphp
                                                    @else
                                                        <img src="{{ asset('public/assets/tooth/png/precisioncut-LL.png') }}" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; bottom: {{ $numberOfelementsInner == 1 ? '-25px' : ($numberOfelementsInner == 2 ? '-60px' : '-90px') }};" alt="precisioncut Inner">
                                                        @php $numberOfelementsInner++; @endphp
                                                    @endif
                                                @endif
                                            ...
                                            @if($bite_ramp && in_array($id, $biteRampUpperIds))
                                                <img src="{{ asset('public/assets/tooth/png/Bite-Ramp.png') }}" style="position: absolute; width: 20px; height: 20px; left: 50%; top: 50%; transform: translate(-50%, -50%); z-index: 13; pointer-events: none;" alt="Bite Ramp Upper">
                                            @endif
                                    ...
                                    <div class="media img-responsive input-group" style="display:flex; flex-wrap: wrap; justify-content:center; gap:10px; position:relative; padding:0.5rem 0 25px;" id="classIILowerArc">
                                        @foreach($lowerTeeth as $id => $tooth)
                                            ...
                                            @if($selected)
                                                @if($buttonOuter)
                                                    <img src="{{ asset('public/assets/tooth/png/buttons.png') }}" class="button-overlay" data-side="upper" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; top: -25px;">
                                                @endif

                                                @if($buttonInner)
                                                    <img src="{{ asset('public/assets/tooth/png/buttons.png') }}" class="button-overlay" data-side="lower" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; bottom: -25px;">
                                                @endif

                                                @if($precision_cut_outer)
                                                    @if($id >=1 && $id <= 8)
                                                        <img src="{{ asset('public/assets/tooth/png/precisioncut-UR.png') }}" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; top: -25px;" alt="precisioncut Outer">
                                                    @else
                                                        <img src="{{ asset('public/assets/tooth/png/precisioncut-UL.png') }}" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; top: -25px;" alt="precisioncut Outer">
                                                    @endif
                                                @endif

                                                @if($precisionCutInner)
                                                    @if($id >=1 && $id <= 8)
                                                        <img src="{{ asset('public/assets/tooth/png/precisioncut-LR.png') }}" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; bottom: -25px;" alt="precisioncut Inner">
                                                    @else
                                                        <img src="{{ asset('public/assets/tooth/png/precisioncut-LL.png') }}" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; bottom: -25px;" alt="precisioncut Inner">
                                                    @endif
                                                @endif

                                                @if($ihookOuter)
                                                    @if($id >=1 && $id <= 8)
                                                        <img src="{{ asset('public/assets/tooth/png/I-hook-UR.png') }}" class="i-hook-overlay" data-side="upper" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; top: -25px;">
                                                    @else
                                                        <img src="{{ asset('public/assets/tooth/png/I-hook-UL.png') }}" class="i-hook-overlay" data-side="upper" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; top: -25px;">
                                                    @endif
                                                @endif

                                                @if($ihookInner)
                                                    @if($id >=1 && $id <= 8)
                                                        <img src="{{ asset('public/assets/tooth/png/I-hook-LR.png') }}" class="i-hook-overlay" data-side="lower" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; bottom: -25px;">
                                                    @else
                                                        <img src="{{ asset('public/assets/tooth/png/I-hook-LL.png') }}" class="i-hook-overlay" data-side="lower" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; bottom: -25px;">
                                                    @endif
                                                @endif

                                                @if($power_arm_attachment_outer)
                                                    <img src="{{ asset('public/assets/tooth/png/Power-Arm-Attachment.png') }}" class="i-hook-overlay" data-side="upper" style="position: absolute; width: 15px; height: 25px; left: 50%; transform: translateX(-50%); z-index: 10; top: -25px;">
                                                @endif

                                                @if($power_arm_attachment_inner)
                                                    <img src="{{ asset('public/assets/tooth/png/Power-Arm-Attachment-lower.png') }}" class="power-arm-attachment-overlay" data-side="lower" style="position: absolute; width: 15px; height: 25px; left: 50%; transform: translateX(-50%); z-index: 11; bottom: -25px;">
                                                @endif


                                                @if($power_ridge_outer)
                                                    <img src="{{ asset('public/assets/tooth/png/Power-Ridge.png') }}" class="power-ridge-overlay" data-side="upper" style="position: absolute; width: 30px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 12; top: -25px;">
                                                @endif

                                                @if($power_ridge_inner)
                                                    <img src="{{ asset('public/assets/tooth/png/Power-Ridge.png') }}" class="power-ridge-overlay" data-side="lower" style="position: absolute; width: 30px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 12; bottom: -25px;">
                                                @endif
