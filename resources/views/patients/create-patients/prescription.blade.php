                        ...
                        <div id="buttons" style="justify-content: center">
                            ...
                            <div class="attachment-inline">
                                ...
                                <label class="inline-item">
                                    ...
                                    <img src="{{ asset('public/assets/tooth/png/Button.webp') }}">
                                ...
                                <div class="teeth-layout-wrapper" style="max-width: 1200px; margin: 0 auto;">
                                    <div class="media img-responsive input-group" style="display:flex; flex-wrap: wrap; justify-content:center; gap:10px; padding:0.5rem 0;" id="classIIUpperArcNew">
                                        ...
                                        @if($selected)
                                            ...
                                            @if($buttonOuter)
                                                <img src="{{ asset('public/assets/tooth/png/Button.webp') }}" class="button-overlay" data-side="upper" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; top: {{ $numberOfelementsOuter == 1 ? '-25px' : ($numberOfelementsOuter == 2 ? '-60px' : '-90px') }};">
                                                @php $numberOfelementsOuter++; @endphp
                                            ...
                                            @if($buttonInner)
                                                <img src="{{ asset('public/assets/tooth/png/Button.webp') }}" class="button-overlay" data-side="lower" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; bottom: {{ $numberOfelementsInner == 1 ? '-25px' : ($numberOfelementsInner == 2 ? '-60px' : '-90px') }}">
                                                @php $numberOfelementsInner++; @endphp
                                            @endif
                                    ...
                                    <div class="media img-responsive input-group" style="display:flex; flex-wrap: wrap; justify-content:center; gap:10px; position:relative; padding:0.5rem 0 25px;" id="classIILowerArc">
                                        @foreach($lowerTeeth as $id => $tooth)
                                            ...
                                            @if($selected)
                                                ...
                                                @if($buttonInner)
                                                    <img src="{{ asset('public/assets/tooth/png/Button.webp') }}" class="button-overlay" data-side="lower" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; bottom: {{ $lowerNumberOfelementsInner == 1 ? '-25px' : ($lowerNumberOfelementsInner == 2 ? '-60px' : '-90px') }}">
                                                    @php $lowerNumberOfelementsInner++; @endphp
                                                @endif
                                                ...
                                                {{-- upper side overlays --}}
                                                    ...
                                                    {{-- 1. Show only one of Button Cutout, Precision Cut, I-Hook (upper) --}}
                                                    @if($buttonOuter)
                                                        <img src="{{ asset('public/assets/tooth/png/Button.webp') }}" class="button-overlay" data-side="upper" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10; top: {{ $lowerNumberOfelementsOuter == 1 ? '-25px' : ($lowerNumberOfelementsOuter == 2 ? '-60px' : '-90px') }};">
                                                        @php $lowerNumberOfelementsOuter++; @endphp
                                                    @elseif($precision_cut_outer)
                                                        @if($id >=17 && $id <= 24)
