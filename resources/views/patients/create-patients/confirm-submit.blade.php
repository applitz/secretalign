<style>
    /* Confirm & Submit Tab: compact paddings & margins without changing font size */
    #pill-tab-div6 .alert {
        padding: 8px 14px;
        margin-bottom: 8px;
    }
    #pill-tab-div6 .alert .icon-item {
        margin-right: 12px;
    }
    #pill-tab-div6 .cs-option-box {
    ...
    #pill-tab-div6 .cs-option-box .form-check-label {
        cursor: pointer;
    }
    #pill-tab-div6 .cs-advisor-banner {
        background-color: #f6fbfb;
        border: 1px solid #d1eded;
        border-left: 4px solid #1C8484;
        border-radius: 6px;
    ...
    #pill-tab-div6 .cs-advisor-banner label {
        color: #1C8484;
    }
    #pill-tab-div6 .cs-footer-buttons {
        margin-top: 8px;
        margin-bottom: 0 !important;
    }
</style>

<div class="tab-pane fade {{ (isset($activeTab) && $activeTab == 'pill-tab-div6') ? 'show active' : '' }}" id="pill-tab-div6" role="tabpanel" aria-labelledby="pill-tab-li6">
    <div class="mb-2 notifications" @if ($fn1==1 && $fn2==1 && $fn3==1 && $fn4==1) style="display: none;" @endif>
        @if ($fn1 == 0)
    ...
    <div class="finish mb-2" @if ($fn1==0 || $fn2==0 || $fn3==0 || $fn4==0) style="display: none;" @endif>
        ...
        @else
            <div class="alert alert-success border-2 d-flex align-items-center" role="alert">
                <div class="bg-success me-3 icon-item"><span
                        class="fas fa-check-circle text-white fs-3"></span></div>
                <p class="mb-0 flex-1">Submit case for staff to review!</p>
            </div>
        @endif

        @if ($patient->is_editable == 1)
            <div class="cs-footer-buttons text-end">
                ...
                <button class="btn btn-primary btn-sm waves-effect waves-light px-3" type="button"
                    onclick="document.getElementById('final-submit-form').submit()">Confirm &amp; Update</button>
            </div>
        @endif
        ...
        <div class="container-fluid px-0">
            <div class="mb-2">
                ...
                <div class="d-flex flex-sm-row flex-column cs-option-box">
                    <div class="me-sm-3">
            ...
            <div class="row">
                <div class="col-md-12 mb-2">
                    ...
                    <select class="form-control form-select form-select-sm" name="advisor" id="advisor" required>
            ...
            <div id="additionalDivs" class="d-none">
                <div class="col-md-12">
                    <div class="mb-2">
                        ...
                        <textarea class="form-control" name="comment" id="comment" rows="2" placeholder="Add a comment"></textarea>
                    </div>
                </div>
            ...
            <div class="d-flex flex-sm-row flex-column cs-option-box">
                ...
                <div>
                    <div class="form-check mb-0 custom-radio radio-select">
                        ...
                        <label class="form-check-label mb-0 fw-bold d-block" for="pricing_package_2">
                            SECRET CONFIDENCE
                        </label>
                    </div>
                </div>
