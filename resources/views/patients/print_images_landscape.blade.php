       ...
       <div class="row">
        <div class="col-4 mb-3 px-4">
            <div class="d-flex text-center justify-content-center d-img-top my-auto ">
                    ...
                    src="{{asset('/storage/PatientFiles/Patient' . $treatment_plan->patient_id . '/' . $treatment_plan->fl_profile)}}">
        ...
        <div class="col-4 mb-3 px-4">
            <div class="d-flex text-center justify-content-center d-img-top my-auto">
                ...
                <img class="img-fluid w-100" style="    border-radius: 1rem !important;"
                    src="{{asset('/storage/PatientFiles/Patient' . $treatment_plan->patient_id . '/' . $treatment_plan->fl_front)}}">
        ...
        <div class="col-4 mb-3 px-4">
            <div class="d-flex text-center justify-content-center d-img my-auto">
                ...
                <img class="img-fluid w-100" style="    border-radius: 1rem !important;"
                    src="{{asset('/storage/PatientFiles/Patient' . $treatment_plan->patient_id . '/' . $treatment_plan->fl_upper_occlusal)}}">

                </div>
        </div>
        <div class="col-4 mb-3 px-4">
            <h6 class="text-dark">Patient's Name: <span class="">{{ $treatment_plan->p_first_name . ' ' . $treatment_plan->p_last_name }}</span></h6>
                <h6 class="text-dark">Doctor's Name: <span class="">{{ $treatment_plan->d_first_name . ' ' . $treatment_plan->d_last_name }}</span></h6>
                <div class="d-flex text-center justify-content-center mt-2 px-4" >
                    <img src="{{ asset('public') }}/assets/secret-logo.png" alt="" class="img-fluid" />
                </div>
        </div>
        <div class="col-4 mb-3 px-4">
            <div class="d-flex text-center justify-content-center d-img my-auto">
                ...
                <img class="img-fluid w-100" style="    border-radius: 1rem !important;"
                    src="{{asset('/storage/PatientFiles/Patient' . $treatment_plan->patient_id . '/' . $treatment_plan->fl_lower_occlusal)}}">
        ...
        <div class="col-4 px-4">
            <div class="d-flex text-center justify-content-center d-img my-auto">
                ...
                <img class="img-fluid w-100" style="    border-radius: 1rem !important;"
                    src="{{asset('/storage/PatientFiles/Patient' . $treatment_plan->patient_id . '/' . $treatment_plan->fl_right_buccal)}}">
        ...
        <div class="col-4 px-4">
            <div class="d-flex text-center justify-content-center d-img my-auto">
                ...
                <img class="img-fluid w-100" style="    border-radius: 1rem !important;"
                    src="{{asset('/storage/PatientFiles/Patient' . $treatment_plan->patient_id . '/' . $treatment_plan->fl_frontal)}}">
        ...
        <div class="col-4 px-4">
            <div class="d-flex text-center justify-content-center d-img my-auto">
                ...
                <img class="img-fluid w-100" style="    border-radius: 1rem !important;"
                    src="{{asset('/storage/PatientFiles/Patient' . $treatment_plan->patient_id . '/' . $treatment_plan->fl_left_buccal)}}">
        ...
        <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        src="{{ asset('public/dashboard') }}/assets/img/icons/left-arrow-from-left.svg" width="20"
                        alt="" />
                    <div class="flex-1">
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        src="{{ asset('public/dashboard') }}/assets/img/icons/arrows-h.svg" width="20" alt="" />
                    <div class="flex-1">
            ...
            <hr />
            <div class="d-flex align-items-start"><img class="me-2"
                    src="{{ asset('public/dashboard') }}/assets/img/icons/paragraph.svg" width="20" alt="" />
                <div class="flex-1">
                ...
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent"> <img
                                ...
                                src="{{ asset('public/dashboard') }}/assets/img/generic/default.png" alt="" /><span
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted"> <img
                                class="img-fluid img-prototype"
                                src="{{ asset('public/dashboard') }}/assets/img/generic/inverted.png" alt="" /><span
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card"> <img
                                class="img-fluid img-prototype"
                                src="{{ asset('public/dashboard') }}/assets/img/generic/card.png" alt="" /><span
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant"> <img
                                class="img-fluid img-prototype"
                                src="{{ asset('public/dashboard') }}/assets/img/generic/vibrant.png" alt="" /><span
                                class="label-text"> Vibrant</span></label>
                    </div>
                </div>
            </div>
            <div class="text-center mt-5"><img class="mb-4"
                    src="{{ asset('public/dashboard') }}/assets/img/icons/spot-illustrations/47.png" alt=""
                    width="120" />
