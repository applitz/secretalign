    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex flex-column mt-3">
                <h4 class="page-title mb-0 font-size-18">Delivered Cases</h4>
                            ...
                            <table id="tech-companies-1" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <a href="{{$patient->tracking_id}}" class="btn btn-link btn-rounded waves-effect" target="_blank">{{$patient->tracking_id}}</a>
                                        </td>
