            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex flex-column mt-3">
                        <h4 class="page-title mb-0 font-size-18">Update New Scan</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ url('/home') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Update New Scan</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="tab-content p-3 mt-3" id="pill-myTabContent">
                        ...
                        <div class="row mb-3">
                            <div class="row mb-3">
                                ...
                                <p class="mb-2"><strong>Date of Birth:</strong> {{ $patient->dob }}</p>
                                <p class="mb-2"><strong>Treatment Type:</strong> {{ $patient->treatment_type == 1 ? 'Treatment Plan Service' : 'Aligners Full-Service' }}</p>
                    ...
                    <div class="mb-3 text-end">
                        <button class="btn btn-primary btn-sm waves-effect waves-light px-3" id="update-scan-data" data-hash-code="{{ $hashCode ? trim($hashCode, '"') : '' }}" data-treatment-plan-id="{{ $patient->id }}" data-patient-id="{{ $patient->patient_id }}">Submit New Scan</button>
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{  asset('public/assets/customjs/update-scan-data.js') }}?v={{ time() }}"></script>
<script>
    $(document).ready(function() {
