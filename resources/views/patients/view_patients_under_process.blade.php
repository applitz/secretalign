    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex flex-column mt-3">
                <h4 class="page-title mb-0 font-size-18">Under Process Cases</h4>
    ...
    @endforeach
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="row align-items-center g-3">
                                    ...
                                    <div class="col-12 position-relative">
                                        <select class="form-select form-select-sm mySelect2" name="case_holder">
                                            <option value="">Select user....</option>
                                            <option value="staff" {{@$_GET['case_holder'] == 'staff' ? 'selected' : ''}}>Staff</option>
                                            <option value="doctor" {{@$_GET['case_holder'] == 'doctor' ? 'selected' : ''}}>Doctor</option>
                                            <option value="lab" {{@$_GET['case_holder'] == 'lab' ? 'selected' : ''}}>Lab</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table id="tech-companies-1" class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">
                                            <a href="javascript:void(0);">Case Holder</a>
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            @if($patient->case_holder == 'doctor')
                                            <span class="badge fw-semi-bold rounded-pill status badge-soft-success">Doctor</span>
                                            @elseif($patient->case_holder == 'staff')
                                            <span class="badge fw-semi-bold rounded-pill status badge-soft-primary">Staff</span>
                                            @elseif($patient->case_holder == 'lab')
                                            <span class="badge fw-semi-bold rounded-pill status badge-soft-warning">Lab</span>
                                            @endif
