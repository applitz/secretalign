...
FilePondPluginImageEdit,
    ...
    */
     ...
     */
            ...
            server: {
                process: {
                    url: URL+'/patient/file/upload/'+PATIENTID+'/'+CASEID+'?id='+id,
                    method: 'POST',
                    headers: {
                ...
                revert: (uniqueFileId, load, error) => {
                    ...
                    fetch(`${URL}/patient/file/revert/${PATIENTID}/${CASEID}?key=${uniqueFileId}&id=` +
                            id, {
                                method: "DELETE",
                                body: formData,
                            }).then(res => res.json())
                ...
                load: (uniqueFileId, load, error, progress, abort, headers) => {
                    ...
                    fetch(`${URL}/patient/file/load/${PATIENTID}?key=${uniqueFileId}`, {
                            method: "GET",
                            signal,
                        })
                        .then(res => {
