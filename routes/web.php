...
use App\Http\Controllers\PatientMailOverview;
...
Route::get('/patient/{phase}', [PatientMailOverview::class, 'mailiframe'])->name('mail-iframe');
...
Route::post('/patient/case-overview/send-to-advisor', [PatientOverview::class, 'send_to_advisor'])->name("send-to-advisor");

Route::post('/patient/case-overview/send-to-lab', [PatientOverview::class, 'send_from_staff_to_lab']);
Route::post('/patient/case-overview/send-from-lab-to-staff', [PatientOverview::class, 'send_from_lab_to_staff']);
...
Route::post('/patient/case-overview/send-from-lab-to-staff/submit-files', [PatientOverview::class, 'submit_files'])->name("submit-files");
Route::post('/patient/case-overview/submit-setup-files', [PatientOverview::class, 'submit_setup_files']);
Route::post('/patient/case-overview/request-setup-files-from-lab', [PatientOverview::class, 'request_setup_files']);
Route::post('/patient/case-overview/submit/tracking-id', [PatientOverview::class, 'submit_tracking_id']);

Route::post('/patient/case-overview/submit/send-to-doctor-for-modification', [PatientOverview::class, 'send_to_doctor_for_modification']);
...
Route::post('/patient/case-overview/send-from-lab-to-staff/cancel-request-after-submit', [PatientOverview::class, 'cancel_treatment_after_submit'])->name("cancel-treatment-after-submit");
Route::post('/patient/case-overview/send-from-staff-to-doctor', [PatientOverview::class, 'send_form_staff_to_doctor']);
Route::post('/patient/case-overview/send-to-the-doctor-for-modification', [PatientOverview::class, 'send_to_the_doctor_for_modification']);
...
Route::post('/patient/case-overview/case/set-reminder-for-doctoer', [PatientOverview::class, 'setReminderForDoctor'])->name("set-reminder-for-doctoer");;

Route::get('/patient/send-approve-mail', [PatientOverview::class, 'sendApproveMail'])->name('send-approve-mail');
...
//secret integration
Route::post('/patient/case-overview/secret/login', [PatientOverview::class, 'getSecretLogin'])->name('secret-login');
