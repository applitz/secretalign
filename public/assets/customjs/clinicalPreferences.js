...
function toggleButton(toothNumber, side) {
    ...
    if (existingButton.length > 0) {
        ...
        var buttonImg = $('<img src="' + baseUrl + '/public/assets/tooth/png/Button.webp" class="button-overlay" data-side="' + side + '" style="position: absolute; width: 20px; height: 20px; left: 50%; transform: translateX(-50%); z-index: 10;">');
