    ...
    var list = function() {
        ...
        $("#tasks-list").dataTable({
            ...
            "columns": [
                ...
                { 'title': 'Doctor', "data": "user_full_name", className: "wrap-two-lines", orderable: true, searchable: false },
                { 'title': 'Country', "data": "country", orderable: false, searchable: false },
                { 'title': 'Patient', "data": "patient_full_name", orderable: true, searchable: true },
                ...
                { 'title': 'Task Date', "data": "created_at", orderable: true, searchable: false },
