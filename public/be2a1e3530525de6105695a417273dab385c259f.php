...
<div class="modal fade" id="precision-cuts-placement-modal" tabindex="-1" aria-labelledby="precision-cuts-placement-modal-Label" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="<?php echo e(asset('public/assets/Precision-Cut.png')); ?>" alt="Precision Cuts Placement" class="img-fluid shadow-sm">
            </div>
...
<div class="modal fade" id="cutouts-placement-modal" tabindex="-1" aria-labelledby="cutouts-placement-modal-Label" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="<?php echo e(asset('public/assets/Cutout.png')); ?>" alt="Precision Cuts Placement" class="img-fluid shadow-sm">
            </div>
...
<div class="modal fade" id="i-hook-modal" tabindex="-1" aria-labelledby="i-hook-modal-Label" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="<?php echo e(asset('public/assets/I-Hooks.jpg')); ?>" alt="Precision Cuts Placement" class="img-fluid shadow-sm">
            </div>
...
<div class="modal fade" id="bite-keeper-modal" tabindex="-1" aria-labelledby="bite-keeper-modal-Label" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="<?php echo e(asset('public/assets/bite-keeper.png')); ?>" alt="Precision Cuts Placement" class="img-fluid shadow-sm">
            </div>
...
<div class="modal fade" id="secret-wings-modal" tabindex="-1" aria-labelledby="secret-wings-modal-Label" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="<?php echo e(asset('public/assets/secret-wings.png')); ?>" alt="Precision Cuts Placement" class="img-fluid shadow-sm">
            </div>
...
<div class="modal fade" id="add-pontic-modal" tabindex="-1" aria-labelledby="add-pontic-modal-Label" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="<?php echo e(asset('public/assets/pontic.jpg')); ?>" alt="Precision Cuts Placement" class="img-fluid shadow-sm">
            </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-6">
                        <img src="<?php echo e(asset('public/assets/bite-turbos.png')); ?>" alt="Precision Cuts Placement" class="img-fluid shadow-sm">
                    </div>
                    <div class="col-6">
                        <img src="<?php echo e(asset('public/assets/bite-turbos-2.png')); ?>" alt="Precision Cuts Placement" class="img-fluid shadow-sm">
                    </div>
                </div>
...
<?php /**PATH /home/u531876341/domains/secretalign-user.com/public_html/resources/views/layouts/modal.blade.php ENDPATH**/ ?>