      ...
      <tbody>
        <tr>
          <td style="width: 596px; vertical-align: top; padding-left: 0; padding-right: 0; padding-top: 20px; padding-bottom: 10px;" width="596">
            ...
            <!-- Your logo is here -->
            <img style="width: 187px; max-width: 187px; height: 55px; max-height: 55px; text-align: center; color: #ffffff;" alt="Logo" src="<?php echo e(asset('public')); ?>/assets/secret-logo.png" align="center" width="180" height="85">
        ...
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 20px;" width="596">
                <h1 style="font-size: 20px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000;">Dear <?php echo e($doctor_name); ?></h1>
                ...
                <p style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #919293;">
                   The Smart STL files for your Patient <?php echo e($patient_name); ?> are ready and have been uploaded automatically into SECRET Navigator. Please login into the SECRET Navigator and complete submitting your order.
                </p>
                ...
                <hr>
                <p style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #919293;">
                    If you're having trouble clicking the "View Tasks" button, copy and paste the URL below into your web browser: <a href="<?php echo e(route('home')); ?>" target="_blank" style="color: #0000EE;"><?php echo e(route('home')); ?></a>
                </p>
...
<?php /**PATH D:\xampp\htdocs\secretalign\resources\views/emails/weebhook-success.blade.php ENDPATH**/ ?>