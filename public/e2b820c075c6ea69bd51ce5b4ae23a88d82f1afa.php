        ...
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 20px;" width="596">
                <h1 style="font-size: 20px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000;">Dear <?php echo e($name); ?></h1>
...
<?php /**PATH D:\xampp\htdocs\secretalign\resources\views/emails/weebhook-faild-called.blade.php ENDPATH**/ ?>