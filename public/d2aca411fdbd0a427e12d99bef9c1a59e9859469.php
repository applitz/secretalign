                ...
                <div class="tab-content p-3 mt-3" id="pill-myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="pill-tab-div1" role="tabpanel">
                        ...
                        <div class="mb-3 text-end">
                            <button class="btn btn-primary btn-sm waves-effect waves-light px-3" id="submit-patient-info" <?php if(@$patient->first_name
                    ...
                    <div class="tab-pane fade" id="pill-tab-li-treatment-type-div" role="tabpanel">
                        ...
                        <div class="container py-3">
                            <div class="row g-4">
                                ...
                                <div class="col-12 col-md-6" style="height:580px">
                                    <div class="plan-box d-flex flex-column justify-content-end" data-plan-type="treatment" style="background-image: url('<?php echo e(asset('public')); ?>/assets/Treatment-Plan-Service-light.svg'); background-size: cover; background-position: center; " onclick="selectPlan(this)">
                                        ...
                                        <input type="radio" name="plan" class="d-none" value="1"
                                            <?php if(!empty($patient->treatment_type) && $patient->treatment_type == 1): ?>
                                                checked="checked"
                                            <?php elseif($change_plan == 'false'): ?>
                                                checked="checked"
                                            <?php endif; ?>
                                        >
                                    </div>
                                ...
                                <div class="col-12 col-md-6" style="height:580px">
                                    <div class="plan-box d-flex flex-column justify-content-end"  data-plan-type="aligners" style="background-image: url('<?php echo e(asset('public')); ?>/assets/Aligners-light.svg'); background-size: cover; background-position: center; " <?php if($change_plan == 'true'): ?> onclick="selectPlan(this)" <?php endif; ?>>
                                        ...
                                        <input type="radio" name="plan" class="d-none" value="2"
                                            <?php if(!empty($patient->treatment_type) && $patient->treatment_type == 2 && $change_plan == 'true'): ?>
                                                checked="checked"
                                            <?php endif; ?>>
                                    </div>
                                </div>
                        ...
                        <div class="mb-3 text-end">
                            ...
                            <button  class="btn btn-primary btn-sm waves-effect waves-light px-3"  id="submit-treatment-plan" <?php if(empty($patient->treatment_type)): ?> disabled="disabled" <?php endif; ?>>
                                Next
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="pill-tab-div3" role="tabpanel">
                        <div class="row mb-3">
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-4 col-sm-6 col-12 _dropzone_template" template-key="3">
                                <input class="d-none" name="file3" id="key3" file="<?php echo e(@$patient->fl_front); ?>" data-field="3" type="file">
                                <div class="p-2 border border-primary border-2 d-block mb-1 _dropzone" key="3" style="background-image: url('<?php echo e(asset('public/assets/vector/head-sad.png')); ?>')">
                                    <div class="_dropzone_added _dropzone_added_hidden d-flex flex-column align-items-center justify-content-center">
                                        <span class="text-white fw-semibold" data-text></span>
                                        <img src="<?php echo e(asset('public/assets')); ?>/check-mark.png" style="width: 50px;height: 50px;">
                                    </div>
                                    ...
                                    <div class=" d-flex flex-column _dropzone_edit _dropzone_remove_hidden justify-content-center" style=" top: 149px; z-index: 1000000; position: absolute; width: 225px; left: 0px; text-align: center;">
                                        ...
                                        <img src="<?php echo e(asset('public/assets')); ?>/edit.png" style="width: 50px;height: 50px;margin: 0 auto;">
                                    </div>
                                </div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-4 col-sm-6 col-12 _dropzone_template" template-key="4">
                                <input class="d-none" name="file4" id="key4" file="<?php echo e(@$patient->fl_smile); ?>" data-field="4" type="file">
                                <div class="p-2 border border-primary border-2 d-block mb-1 _dropzone" key="4" style="background-image: url('<?php echo e(asset('public/assets/vector/head-front.png')); ?>')">
                                    <div class="_dropzone_added _dropzone_added_hidden d-flex flex-column align-items-center justify-content-center">
                                        <span class="text-white fw-semibold" data-text></span>
                                        <img src="<?php echo e(asset('public/assets')); ?>/check-mark.png" style="width: 50px;height: 50px;">
                                    </div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-4 col-sm-6 col-12 _dropzone_template" template-key="5">
                                <input class="d-none" name="file5" id="key5" file="<?php echo e(@$patient->fl_profile); ?>" data-field="5" type="file">
                                <div class="p-2 border border-primary border-2 d-block mb-1 _dropzone" key="5" style="background-image: url('<?php echo e(asset('public/assets/vector/head-side.jpg')); ?>') ">
                                    <div class="_dropzone_added _dropzone_added_hidden d-flex flex-column align-items-center justify-content-center">
                                        <span class="text-white fw-semibold" data-text></span>
                                        <img src="<?php echo e(asset('public/assets')); ?>/check-mark.png" style="width: 50px;height: 50px;">
                                    </div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-4 col-sm-6 col-12 _dropzone_template" template-key="6">
                                ...
                                <input class="d-none" name="file6" id="key6" file="<?php echo e(@$patient->fl_frontal); ?>" data-field="6"
                                type="file">
                                <div class="p-2 border border-primary border-2 d-block mb-1 _dropzone" key="6" style="background-image: url('<?php echo e(asset('public/assets/vector/jaw.png')); ?>') ">
                                    <div class="_dropzone_added _dropzone_added_hidden d-flex flex-column align-items-center justify-content-center">
                                        <span class="text-white fw-semibold" data-text></span>
                                        <img src="<?php echo e(asset('public/assets')); ?>/check-mark.png" style="width: 50px;height: 50px;">
                                    </div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-4 col-sm-6 col-12 _dropzone_template" template-key="7">
                                <input class="d-none" name="file7" id="key7" file="<?php echo e(@$patient->fl_right_buccal); ?>" data-field="7" type="file">
                                <div class="p-2 border border-primary border-2 d-block mb-1 _dropzone" key="7" style="background-image: url('<?php echo e(asset('public/assets/vector/jaw-side-left-angle.png')); ?>')">
                                    <div class="_dropzone_added _dropzone_added_hidden d-flex flex-column align-items-center justify-content-center">
                                        <span class="text-white fw-semibold" data-text></span>
                                        <img src="<?php echo e(asset('public/assets')); ?>/check-mark.png" style="width: 50px;height: 50px;">
                                    </div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-4 col-sm-6 col-12 _dropzone_template" template-key="8">
                                <input class="d-none" name="file8" id="key8" file="<?php echo e(@$patient->fl_left_buccal); ?>" data-field="8" type="file">
                                <div class="p-2 border border-primary border-2 d-block mb-1 _dropzone" key="8" style="background-image: url('<?php echo e(asset('public/assets/vector/jaw-side-right-angle.png')); ?>') ">
                                    <div class="_dropzone_added _dropzone_added_hidden d-flex flex-column align-items-center justify-content-center">
                                        <span class="text-white fw-semibold" data-text></span>
                                        <img src="<?php echo e(asset('public/assets')); ?>/check-mark.png" style="width: 50px;height: 50px;">
                                    </div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-4 col-sm-6 col-12 _dropzone_template" template-key="9">
                                ...
                                <input class="d-none" name="file9" id="key9" file="<?php echo e(@$patient->fl_upper_occlusal); ?>" data-field="9" type="file">
                                <div class="p-2 border border-primary border-2 d-block mb-1 _dropzone" key="9" style="background-image: url('<?php echo e(asset('public/assets/vector/upper-jaw.png')); ?>')">
                                    <div class="_dropzone_added _dropzone_added_hidden d-flex flex-column align-items-center justify-content-center">
                                        <span class="text-white fw-semibold" data-text></span>
                                        <img src="<?php echo e(asset('public/assets')); ?>/check-mark.png" style="width: 50px;height: 50px;">
                                    </div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-4 col-sm-6 col-12 _dropzone_template" template-key="10">
                                <input class="d-none" name="file10" id="key10" file="<?php echo e(@$patient->fl_lower_occlusal); ?>" data-field="10" type="file">
                                <div class="p-2 border border-primary border-2 d-block mb-1 _dropzone" key="10" style="background-image: url('<?php echo e(asset('public/assets/vector/down-jaw.png')); ?>')">
                                    <div class="_dropzone_added _dropzone_added_hidden d-flex flex-column align-items-center justify-content-center">
                                        <span class="text-white fw-semibold" data-text></span>
                                        <img src="<?php echo e(asset('public/assets')); ?>/check-mark.png" style="width: 50px;height: 50px;">
                                    </div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-4 col-sm-6 col-12 _dropzone_template" template-key="11">
                                <input class="d-none" name="file11" id="key11" file="<?php echo e(@$patient->fl_panorex); ?>" data-field="11" type="file">
                                    <div class="p-2 border border-primary border-2 d-block mb-1 _dropzone" key="11" style="background-image: url('<?php echo e(asset('public/assets/vector/x-ray-jaw-front.png')); ?>')">
                                        <div class="_dropzone_added _dropzone_added_hidden d-flex flex-column align-items-center justify-content-center">
                                            <span class="text-white fw-semibold" data-text></span>
                                            <img src="<?php echo e(asset('public/assets')); ?>/check-mark.png" style="width: 50px;height: 50px;">
                                        </div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-4 col-sm-6 col-12 _dropzone_template" template-key="12">
                                <input class="d-none" name="file12" id="key12" file="<?php echo e(@$patient->fl_lateral_ceph); ?>" data-field="12" type="file">
                                <div class="p-2 border border-primary border-2 d-block mb-1 _dropzone" key="12" style="background-image: url('<?php echo e(asset('public/assets/vector/x-ray-jaw-side.png')); ?>')">
                                    <div class="_dropzone_added _dropzone_added_hidden d-flex flex-column align-items-center justify-content-center">
                                        <span class="text-white fw-semibold" data-text></span>
                                        <img src="<?php echo e(asset('public/assets')); ?>/check-mark.png" style="width: 50px;height: 50px;">
                                    </div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-4 col-sm-6 col-12 _dropzone_template" template-key="13">
                                <input class="d-none" name="file13" id="key13" file="<?php echo e(@$patient->fl_general_upload); ?>" data-field="13" type="file">
                                <div class="p-2 border border-primary border-2 d-block mb-1 _dropzone" key="13" style="background-image: url('<?php echo e(asset('public/assets/no-image.png')); ?>')">
                                    <div class="_dropzone_added _dropzone_added_hidden d-flex flex-column align-items-center justify-content-center">
                                        <span class="text-white fw-semibold" data-text></span>
                                        <img src="<?php echo e(asset('public/assets')); ?>/check-mark.png" style="width: 50px;height: 50px;">
                                    </div>
                            ...
                            <div class="col-xxl-3 col-lg-4 col-md-4 col-sm-6 col-12">
                                ...
                                <input class="form-control hyperlink" placeholder="https://"
                                    value="<?php echo e(@$patient->fl_general_upload_drive_link); ?>"
                        ...
                        <div class="mb-3 text-end">
                            ...
                            <button class="btn btn-primary btn-sm waves-effect waves-light px-3" id="submit-images" <?php if( @$patient->fl_front &&
                                @$patient->fl_smile &&
                                @$patient->fl_profile &&
                                @$patient->fl_frontal &&
                    ...
                    <div class="tab-pane fade" id="pill-tab-div4" role="tabpanel">
                        ...
                        <div class="mb-3">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" id="treat_upper_arch" name="upper_arch" type="checkbox"
                                    value="1" <?php if($patient->treat_upper_arch == 1): ?> checked <?php endif; ?> />
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" id="treat_lower_arch" name="lower_arch" type="checkbox"
                                    value="1" <?php if($patient->treat_lower_arch == 1): ?> checked <?php endif; ?> />
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" id="midline1" type="checkbox"
                                                    name="midline" value="maintain" <?php if($patient->midline ==
                                                'maintain'): ?> checked <?php endif; ?> />
                                                <label class="form-check-label" for="midline1">Maintain</label>
                                            </div>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" id="midline2" type="checkbox"
                                                    name="midline" value="Move Upper to Lower" <?php if($patient->midline == 'Move Upper to Lower'): ?>
                                                checked <?php endif; ?> />
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" id="midline3" type="checkbox"
                                                    name="midline" value="Move Lower to Upper" <?php if($patient->midline == 'Move Lower to Upper'): ?>
                                                checked <?php endif; ?> />
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" id="midline4" type="checkbox"
                                                    name="midline" value="Independent (move both)" <?php if($patient->midline == 'Independent (move both)'): ?>
                                                checked <?php endif; ?> />
                                        ...
                                        <div class="mb-3 d-none">
                                            <div class="form-check form-check-inline mb-2">
                                                <input class="form-check-input" type="radio" name="align_to_facial_midline" id="align_to_facial_midline1" value="Maintain" <?php echo e($patient->align_to_facial_midline == 'Maintain' ? 'checked' : ''); ?> <?php echo e($patient->align_to_facial_midline == "" || $patient->align_to_facial_midline == null ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="align_to_facial_midline1">
                                                    Maintain
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline mb-2">
                                                <input class="form-check-input" type="radio" name="align_to_facial_midline" id="align_to_facial_midline2" value="Move Upper to Lower" <?php echo e($patient->align_to_facial_midline == 'Move Upper to Lower' ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="align_to_facial_midline2">
                                                    Move Upper to Lower
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline mb-2">
                                                <input class="form-check-input" type="radio" name="align_to_facial_midline" id="align_to_facial_midline3" value="Move Lower to Upper" <?php echo e($patient->align_to_facial_midline == 'Move Lower to Upper' ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="align_to_facial_midline3">
                                                    Move Lower to Upper
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline mb-2">
                                                <input class="form-check-input" type="radio" name="align_to_facial_midline" id="align_to_facial_midline4" value="Independent (move both)" <?php echo e($patient->align_to_facial_midline == 'Independent (move both)' ? 'checked' : ''); ?>>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="midline_notes"
                                                name="midline_notes"><?php echo e($patient->midline_notes); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" id="archform1" type="checkbox"
                                                    name="archform" value="maintain" <?php if($patient->archform ==
                                                'maintain'): ?> checked <?php endif; ?> />
                                                <label class="form-check-label" for="archform1">Maintain</label>
                                            </div>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" id="archform2" type="checkbox"
                                                    name="archform" value="correct" <?php if($patient->archform ==
                                                'correct'): ?> checked <?php endif; ?> />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="archform_notes"
                                                name="archform_notes"><?php echo e($patient->archform_notes); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" id="class1" type="checkbox" name="class"
                                                    value="maintain" <?php if($patient->class == 'maintain'): ?> checked <?php endif; ?>
                                                />
                                                <label class="form-check-label" for="class1">Maintain</label>
                                            </div>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" id="class2" type="checkbox" name="class"
                                                    value="correct" <?php if($patient->class == 'correct'): ?> checked <?php endif; ?> />
                                                            ...
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="pcp_ur" id="pcp_ur8" <?php if(in_array(8,
                                                                        $pcp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="pcp_ur" id="pcp_ur7" <?php if(in_array(7,
                                                                        $pcp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="pcp_ur" id="pcp_ur6" <?php if(in_array(6,
                                                                        $pcp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="pcp_ur" id="pcp_ur5" <?php if(in_array(5,
                                                                        $pcp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="pcp_ur" id="pcp_ur4" <?php if(in_array(4,
                                                                        $pcp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="pcp_ur" id="pcp_ur3" <?php if(in_array(3,
                                                                        $pcp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="pcp_ur" id="pcp_ur2" <?php if(in_array(2,
                                                                        $pcp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="pcp_ur" id="pcp_ur1" <?php if(in_array(1,
                                                                        $pcp_ur)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="pcp_ul" id="pcp_ul1" <?php if(in_array(1,
                                                                        $pcp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="pcp_ul" id="pcp_ul2" <?php if(in_array(2,
                                                                        $pcp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="pcp_ul" id="pcp_ul3" <?php if(in_array(3,
                                                                        $pcp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="pcp_ul" id="pcp_ul4" <?php if(in_array(4,
                                                                        $pcp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="pcp_ul" id="pcp_ul5" <?php if(in_array(5,
                                                                        $pcp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="pcp_ul" id="pcp_ul6" <?php if(in_array(6,
                                                                        $pcp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="pcp_ul" id="pcp_ul7" <?php if(in_array(7,
                                                                        $pcp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="pcp_ul" id="pcp_ul8" <?php if(in_array(8,
                                                                        $pcp_ul)): ?> checked <?php endif; ?>>
                                                                </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="pcp_lr" id="pcp_lr8" <?php if(in_array(8,
                                                                        $pcp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="pcp_lr" id="pcp_lr7" <?php if(in_array(7,
                                                                        $pcp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="pcp_lr" id="pcp_lr6" <?php if(in_array(6,
                                                                        $pcp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="pcp_lr" id="pcp_lr5" <?php if(in_array(5,
                                                                        $pcp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="pcp_lr" id="pcp_lr4" <?php if(in_array(4,
                                                                        $pcp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="pcp_lr" id="pcp_lr3" <?php if(in_array(3,
                                                                        $pcp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="pcp_lr" id="pcp_lr2" <?php if(in_array(2,
                                                                        $pcp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="pcp_lr" id="pcp_lr1" <?php if(in_array(1,
                                                                        $pcp_lr)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="pcp_ll" id="pcp_ll1" <?php if(in_array(1,
                                                                        $pcp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="pcp_ll" id="pcp_ll2" <?php if(in_array(2,
                                                                        $pcp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="pcp_ll" id="pcp_ll3" <?php if(in_array(3,
                                                                        $pcp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="pcp_ll" id="pcp_ll4" <?php if(in_array(4,
                                                                        $pcp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="pcp_ll" id="pcp_ll5" <?php if(in_array(5,
                                                                        $pcp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="pcp_ll" id="pcp_ll6" <?php if(in_array(6,
                                                                        $pcp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="pcp_ll" id="pcp_ll7" <?php if(in_array(7,
                                                                        $pcp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="pcp_ll" id="pcp_ll8" <?php if(in_array(8,
                                                                        $pcp_ll)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    L
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="ctp_ur" id="ctp_ur8" <?php if(in_array(8,
                                                                        $ctp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="ctp_ur" id="ctp_ur7" <?php if(in_array(7,
                                                                        $ctp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="ctp_ur" id="ctp_ur6" <?php if(in_array(6,
                                                                        $ctp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="ctp_ur" id="ctp_ur5" <?php if(in_array(5,
                                                                        $ctp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="ctp_ur" id="ctp_ur4" <?php if(in_array(4,
                                                                        $ctp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="ctp_ur" id="ctp_ur3" <?php if(in_array(3,
                                                                        $ctp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="ctp_ur" id="ctp_ur2" <?php if(in_array(2,
                                                                        $ctp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="ctp_ur" id="ctp_ur1" <?php if(in_array(1,
                                                                        $ctp_ur)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="ctp_ul" id="ctp_ul1" <?php if(in_array(1,
                                                                        $ctp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="ctp_ul" id="ctp_ul2" <?php if(in_array(2,
                                                                        $ctp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="ctp_ul" id="ctp_ul3" <?php if(in_array(3,
                                                                        $ctp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="ctp_ul" id="ctp_ul4" <?php if(in_array(4,
                                                                        $ctp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="ctp_ul" id="ctp_ul5" <?php if(in_array(5,
                                                                        $ctp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="ctp_ul" id="ctp_ul6" <?php if(in_array(6,
                                                                        $ctp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="ctp_ul" id="ctp_ul7" <?php if(in_array(7,
                                                                        $ctp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="ctp_ul" id="ctp_ul8" <?php if(in_array(8,
                                                                        $ctp_ul)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    U
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="ctp_lr" id="ctp_lr8" <?php if(in_array(8,
                                                                        $ctp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="ctp_lr" id="ctp_lr7" <?php if(in_array(7,
                                                                        $ctp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="ctp_lr" id="ctp_lr6" <?php if(in_array(6,
                                                                        $ctp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="ctp_lr" id="ctp_lr5" <?php if(in_array(5,
                                                                        $ctp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="ctp_lr" id="ctp_lr4" <?php if(in_array(4,
                                                                        $ctp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="ctp_lr" id="ctp_lr3" <?php if(in_array(3,
                                                                        $ctp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="ctp_lr" id="ctp_lr2" <?php if(in_array(2,
                                                                        $ctp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="ctp_lr" id="ctp_lr1" <?php if(in_array(1,
                                                                        $ctp_lr)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="ctp_ll" id="ctp_ll1" <?php if(in_array(1,
                                                                        $ctp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="ctp_ll" id="ctp_ll2" <?php if(in_array(2,
                                                                        $ctp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="ctp_ll" id="ctp_ll3" <?php if(in_array(3,
                                                                        $ctp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="ctp_ll" id="ctp_ll4" <?php if(in_array(4,
                                                                        $ctp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="ctp_ll" id="ctp_ll5" <?php if(in_array(5,
                                                                        $ctp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="ctp_ll" id="ctp_ll6" <?php if(in_array(6,
                                                                        $ctp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="ctp_ll" id="ctp_ll7" <?php if(in_array(7,
                                                                        $ctp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="ctp_ll" id="ctp_ll8" <?php if(in_array(8,
                                                                        $ctp_ll)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    L
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="ihook_ur" id="ihook_ur8" <?php if(in_array(8,
                                                                        $ihook_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="ihook_ur" id="ihook_ur7" <?php if(in_array(7,
                                                                        $ihook_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="ihook_ur" id="ihook_ur6" <?php if(in_array(6,
                                                                        $ihook_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="ihook_ur" id="ihook_ur5" <?php if(in_array(5,
                                                                        $ihook_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="ihook_ur" id="ihook_ur4" <?php if(in_array(4,
                                                                        $ihook_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="ihook_ur" id="ihook_ur3" <?php if(in_array(3,
                                                                        $ihook_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="ihook_ur" id="ihook_ur2" <?php if(in_array(2,
                                                                        $ihook_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="ihook_ur" id="ihook_ur" <?php if(in_array(1,
                                                                        $ihook_ur)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="ihook_ul" id="ihook_ul1" <?php if(in_array(1,
                                                                        $ihook_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="ihook_ul" id="ihook_ul2" <?php if(in_array(2,
                                                                        $ihook_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="ihook_ul" id="ihook_ul3" <?php if(in_array(3,
                                                                        $ihook_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="ihook_ul" id="ihook_ul4" <?php if(in_array(4,
                                                                        $ihook_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="ihook_ul" id="ihook_ul5" <?php if(in_array(5,
                                                                        $ihook_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="ihook_ul" id="ihook_ul6" <?php if(in_array(6,
                                                                        $ihook_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="ihook_ul" id="ihook_ul7" <?php if(in_array(7,
                                                                        $ihook_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="ihook_ul" id="ihook_ul8" <?php if(in_array(8,
                                                                        $ihook_ul)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    U
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="ihook_lr" id="ihook_lr8" <?php if(in_array(8,
                                                                        $ihook_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="ihook_lr" id="ihook_lr7" <?php if(in_array(7,
                                                                        $ihook_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="ihook_lr" id="ihook_lr6" <?php if(in_array(6,
                                                                        $ihook_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="pcp_lr" id="ihook_lr5" <?php if(in_array(5,
                                                                        $ihook_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="ihook_lr" id="ihook_lr4" <?php if(in_array(4,
                                                                        $ihook_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="ihook_lr" id="ihook_lr3" <?php if(in_array(3,
                                                                        $ihook_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="ihook_lr" id="ihook_lr2" <?php if(in_array(2,
                                                                        $ihook_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="ihook_lr" id="ihook_lr1" <?php if(in_array(1,
                                                                        $ihook_lr)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="ihook_ll" id="ihook_ll1" <?php if(in_array(1,
                                                                        $ihook_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="ihook_ll" id="ihook_ll2" <?php if(in_array(2,
                                                                        $ihook_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="ihook_ll" id="ihook_ll3" <?php if(in_array(3,
                                                                        $ihook_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="ihook_ll" id="ihook_ll4" <?php if(in_array(4,
                                                                        $ihook_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="ihook_ll" id="ihook_ll5" <?php if(in_array(5,
                                                                        $ihook_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="ihook_ll" id="ihook_ll6" <?php if(in_array(6,
                                                                        $ihook_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="ihook_ll" id="ihook_ll7" <?php if(in_array(7,
                                                                        $ihook_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="ihook_ll" id="ihook_ll8" <?php if(in_array(8,
                                                                        $ihook_ll)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    L
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="class_notes"
                                                name="class_notes"><?php echo e($patient->class_notes); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="size_issues1" type="radio"
                                                    name="size_issues" value="IPR" <?php if($patient->tooth_size_issues ==
                                                'IPR'): ?> checked <?php endif; ?> />
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="size_issues2" type="radio"
                                                    ...
                                                    <?php if($patient->tooth_size_issues == 'Restorative (No IPR)'): ?>
                                                checked <?php endif; ?> />
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="size_issues3" type="radio"
                                                    ...
                                                    <?php if($patient->tooth_size_issues == 'Accept best fit (No
                                                IPR/Restorative)'): ?> checked <?php endif; ?> />
                                                <label class="form-check-label" for="size_issues3">Accept best fit (No IPR/Restorative)</label>
                                            </div>
                                        </div>
                                        <hr>
                                     <div id="presc-location-section" class="<?php echo e($patient->tooth_size_issues == 'IPR' ? '' : 'd-none'); ?>">
                                        <h5>Location</h5>
                                        <div class="mb-3">
                                            <label>Upper</label>
                                            <select id="location_upper" name="location_upper" class="form-select">
                                                <option value="" selected disabled>Select</option>
                                                <option value="3-3" <?php if($patient->location_upper == '3-3'): ?> selected
                                                    <?php endif; ?>>3-3</option>
                                                <option value="4-4" <?php if($patient->location_upper == '4-4'): ?> selected
                                                    <?php endif; ?>>4-4</option>
                                                <option value="6-6" <?php if($patient->location_upper == '6-6'): ?> selected
                                                    <?php endif; ?>>6-6</option>
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            <label>Lower</label>
                                            <select id="location_lower" name="location_lower" class="form-select">
                                                <option value="" selected disabled>Select</option>
                                                <option value="3-3" <?php if($patient->location_lower == '3-3'): ?> selected
                                                    <?php endif; ?>>3-3</option>
                                                <option value="4-4" <?php if($patient->location_lower == '4-4'): ?> selected
                                                    <?php endif; ?>>4-4</option>
                                                <option value="6-6" <?php if($patient->location_lower == '6-6'): ?> selected
                                                    <?php endif; ?>>6-6</option>
                                            </select>
                                        </div>
                                        <hr>
                                     </div>
                                        <div id="pres-limits-section"  class="<?php echo e($patient->tooth_size_issues == 'IPR' ? '' : 'd-none'); ?>">
                                            <h5>Limits</h5>
                                            <div class="mb-3">
                                                <label>Maximum Ant. IPR/Contact 0.1-0.6mm</label>
                                                <input class="form-control" type="number" name="limits"
                                                    value="<?php echo e($patient->limits); ?>" id="limits" step="0.05" min="0.1"
                                                    max="0.6">
                                            </div>
                                            <hr>
                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="ofp_ur" id="ofp_ur8" <?php if(in_array(8,
                                                                        $ofp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="ofp_ur" id="ofp_ur7" <?php if(in_array(7,
                                                                        $ofp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="ofp_ur" id="ofp_ur6" <?php if(in_array(6,
                                                                        $ofp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="ofp_ur" id="ofp_ur5" <?php if(in_array(5,
                                                                        $ofp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="ofp_ur" id="ofp_ur4" <?php if(in_array(4,
                                                                        $ofp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="ofp_ur" id="ofp_ur3" <?php if(in_array(3,
                                                                        $ofp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="ofp_ur" id="ofp_ur2" <?php if(in_array(2,
                                                                        $ofp_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="ofp_ur" id="ofp_ur1" <?php if(in_array(1,
                                                                        $ofp_ur)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="ofp_ul" id="ofp_ul1" <?php if(in_array(1,
                                                                        $ofp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="ofp_ul" id="ofp_ul2" <?php if(in_array(2,
                                                                        $ofp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="ofp_ul" id="ofp_ul3" <?php if(in_array(3,
                                                                        $ofp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="ofp_ul" id="ofp_ul4" <?php if(in_array(4,
                                                                        $ofp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="ofp_ul" id="ofp_ul5" <?php if(in_array(5,
                                                                        $ofp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="ofp_ul" id="ofp_ul6" <?php if(in_array(6,
                                                                        $ofp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="ofp_ul" id="ofp_ul7" <?php if(in_array(7,
                                                                        $ofp_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="ofp_ul" id="ofp_ul8" <?php if(in_array(8,
                                                                        $ofp_ul)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    U
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="ofp_lr" id="ofp_lr8" <?php if(in_array(8,
                                                                        $ofp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="ofp_lr" id="ofp_lr7" <?php if(in_array(7,
                                                                        $ofp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="ofp_lr" id="ofp_lr6" <?php if(in_array(6,
                                                                        $ofp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="ofp_lr" id="ofp_lr5" <?php if(in_array(5,
                                                                        $ofp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="ofp_lr" id="ofp_lr4" <?php if(in_array(4,
                                                                        $ofp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="ofp_lr" id="ofp_lr3" <?php if(in_array(3,
                                                                        $ofp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="ofp_lr" id="ofp_lr2" <?php if(in_array(2,
                                                                        $ofp_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="ofp_lr" id="ofp_lr1" <?php if(in_array(1,
                                                                        $ofp_lr)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="ofp_ll" id="ofp_ll1" <?php if(in_array(1,
                                                                        $ofp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="ofp_ll" id="ofp_ll2" <?php if(in_array(2,
                                                                        $ofp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="ofp_ll" id="ofp_ll3" <?php if(in_array(3,
                                                                        $ofp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="ofp_ll" id="ofp_ll4" <?php if(in_array(4,
                                                                        $ofp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="ofp_ll" id="ofp_ll5" <?php if(in_array(5,
                                                                        $ofp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="ofp_ll" id="ofp_ll6" <?php if(in_array(6,
                                                                        $ofp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="ofp_ll" id="ofp_ll7" <?php if(in_array(7,
                                                                        $ofp_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="ofp_ll" id="ofp_ll8" <?php if(in_array(8,
                                                                        $ofp_ll)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    L
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="tmr_ur" id="tmr_ur8" <?php if(in_array(8,
                                                                        $tmr_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="tmr_ur" id="tmr_ur7" <?php if(in_array(7,
                                                                        $tmr_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="tmr_ur" id="tmr_ur6" <?php if(in_array(6,
                                                                        $tmr_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="tmr_ur" id="tmr_ur5" <?php if(in_array(5,
                                                                        $tmr_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="tmr_ur" id="tmr_ur4" <?php if(in_array(4,
                                                                        $tmr_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="tmr_ur" id="tmr_ur3" <?php if(in_array(3,
                                                                        $tmr_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="tmr_ur" id="tmr_ur2" <?php if(in_array(2,
                                                                        $tmr_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="tmr_ur" id="tmr_ur1" <?php if(in_array(1,
                                                                        $tmr_ur)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="tmr_ul" id="tmr_ul1" <?php if(in_array(1,
                                                                        $tmr_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="tmr_ul" id="tmr_ul2" <?php if(in_array(2,
                                                                        $tmr_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="tmr_ul" id="tmr_ul3" <?php if(in_array(3,
                                                                        $tmr_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="tmr_ul" id="tmr_ul4" <?php if(in_array(4,
                                                                        $tmr_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="tmr_ul" id="tmr_ul5" <?php if(in_array(5,
                                                                        $tmr_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="tmr_ul" id="tmr_ul6" <?php if(in_array(6,
                                                                        $tmr_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="tmr_ul" id="tmr_ul7" <?php if(in_array(7,
                                                                        $tmr_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="tmr_ul" id="tmr_ul8" <?php if(in_array(8,
                                                                        $tmr_ul)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    U
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="tmr_lr" id="tmr_lr8" <?php if(in_array(8,
                                                                        $tmr_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="tmr_lr" id="tmr_lr7" <?php if(in_array(7,
                                                                        $tmr_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="tmr_lr" id="tmr_lr6" <?php if(in_array(6,
                                                                        $tmr_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="tmr_lr" id="tmr_lr5" <?php if(in_array(5,
                                                                        $tmr_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="tmr_lr" id="tmr_lr4" <?php if(in_array(4,
                                                                        $tmr_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="tmr_lr" id="tmr_lr3" <?php if(in_array(3,
                                                                        $tmr_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="tmr_lr" id="tmr_lr2" <?php if(in_array(2,
                                                                        $tmr_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="tmr_lr" id="tmr_lr1" <?php if(in_array(1,
                                                                        $tmr_lr)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="tmr_ll" id="tmr_ll1" <?php if(in_array(1,
                                                                        $tmr_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="tmr_ll" id="tmr_ll2" <?php if(in_array(2,
                                                                        $tmr_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="tmr_ll" id="tmr_ll3" <?php if(in_array(3,
                                                                        $tmr_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="tmr_ll" id="tmr_ll4" <?php if(in_array(4,
                                                                        $tmr_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="tmr_ll" id="tmr_ll5" <?php if(in_array(5,
                                                                        $tmr_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="tmr_ll" id="tmr_ll6" <?php if(in_array(6,
                                                                        $tmr_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="tmr_ll" id="tmr_ll7" <?php if(in_array(7,
                                                                        $tmr_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="tmr_ll" id="tmr_ll8" <?php if(in_array(8,
                                                                        $tmr_ll)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    L
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="mut_ur" id="mut_ur8" <?php if(in_array(8,
                                                                        $mut_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="mut_ur" id="mut_ur7" <?php if(in_array(7,
                                                                        $mut_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="mut_ur" id="mut_ur6" <?php if(in_array(6,
                                                                        $mut_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="mut_ur" id="mut_ur5" <?php if(in_array(5,
                                                                        $mut_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="mut_ur" id="mut_ur4" <?php if(in_array(4,
                                                                        $mut_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="mut_ur" id="mut_ur3" <?php if(in_array(3,
                                                                        $mut_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="mut_ur" id="mut_ur2" <?php if(in_array(2,
                                                                        $mut_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="mut_ur" id="mut_ur1" <?php if(in_array(1,
                                                                        $mut_ur)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="mut_ul" id="mut_ul1" <?php if(in_array(1,
                                                                        $mut_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="mut_ul" id="mut_ul2" <?php if(in_array(2,
                                                                        $mut_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="mut_ul" id="mut_ul3" <?php if(in_array(3,
                                                                        $mut_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="mut_ul" id="mut_ul4" <?php if(in_array(4,
                                                                        $mut_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="mut_ul" id="mut_ul5" <?php if(in_array(5,
                                                                        $mut_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="mut_ul" id="mut_ul6" <?php if(in_array(6,
                                                                        $mut_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="mut_ul" id="mut_ul7" <?php if(in_array(7,
                                                                        $mut_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="mut_ul" id="mut_ul8" <?php if(in_array(8,
                                                                        $mut_ul)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    U
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="mut_lr" id="mut_lr8" <?php if(in_array(8,
                                                                        $mut_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="mut_lr" id="mut_lr7" <?php if(in_array(7,
                                                                        $mut_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="mut_lr" id="mut_lr6" <?php if(in_array(6,
                                                                        $mut_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="mut_lr" id="mut_lr5" <?php if(in_array(5,
                                                                        $mut_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="mut_lr" id="mut_lr4" <?php if(in_array(4,
                                                                        $mut_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="mut_lr" id="mut_lr3" <?php if(in_array(3,
                                                                        $mut_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="mut_lr" id="mut_lr2" <?php if(in_array(2,
                                                                        $mut_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="mut_lr" id="mut_lr1" <?php if(in_array(1,
                                                                        $mut_lr)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label left">
                                                                    L
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="mut_ll" id="mut_ll1" <?php if(in_array(1,
                                                                        $mut_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="mut_ll" id="mut_ll2" <?php if(in_array(2,
                                                                        $mut_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="mut_ll" id="mut_ll3" <?php if(in_array(3,
                                                                        $mut_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="mut_ll" id="mut_ll4" <?php if(in_array(4,
                                                                        $mut_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="mut_ll" id="mut_ll5" <?php if(in_array(5,
                                                                        $mut_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="mut_ll" id="mut_ll6" <?php if(in_array(6,
                                                                        $mut_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="mut_ll" id="mut_ll7" <?php if(in_array(7,
                                                                        $mut_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="mut_ll" id="mut_ll8" <?php if(in_array(8,
                                                                        $mut_ll)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    L
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="tbe_ur" id="tbe_ur8" <?php if(in_array(8,
                                                                        $tbe_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="tbe_ur" id="tbe_ur7" <?php if(in_array(7,
                                                                        $tbe_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="tbe_ur" id="tbe_ur6" <?php if(in_array(6,
                                                                        $tbe_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="tbe_ur" id="tbe_ur5" <?php if(in_array(5,
                                                                        $tbe_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="tbe_ur" id="tbe_ur4" <?php if(in_array(4,
                                                                        $tbe_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="tbe_ur" id="tbe_ur3" <?php if(in_array(3,
                                                                        $tbe_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="tbe_ur" id="tbe_ur2" <?php if(in_array(2,
                                                                        $tbe_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="tbe_ur" id="tbe_ur1" <?php if(in_array(1,
                                                                        $tbe_ur)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="tbe_ul" id="tbe_ul1" <?php if(in_array(1,
                                                                        $tbe_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="tbe_ul" id="tbe_ul2" <?php if(in_array(2,
                                                                        $tbe_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="tbe_ul" id="tbe_ul3" <?php if(in_array(3,
                                                                        $tbe_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="tbe_ul" id="tbe_ul4" <?php if(in_array(4,
                                                                        $tbe_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="tbe_ul" id="tbe_ul5" <?php if(in_array(5,
                                                                        $tbe_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="tbe_ul" id="tbe_ul6" <?php if(in_array(6,
                                                                        $tbe_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="tbe_ul" id="tbe_ul7" <?php if(in_array(7,
                                                                        $tbe_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="tbe_ul" id="tbe_ul8" <?php if(in_array(8,
                                                                        $tbe_ul)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    U
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="tbe_lr" id="tbe_lr8" <?php if(in_array(8,
                                                                        $tbe_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="tbe_lr" id="tbe_lr7" <?php if(in_array(7,
                                                                        $tbe_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="tbe_lr" id="tbe_lr6" <?php if(in_array(6,
                                                                        $tbe_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="tbe_lr" id="tbe_lr5" <?php if(in_array(5,
                                                                        $tbe_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="tbe_lr" id="tbe_lr4" <?php if(in_array(4,
                                                                        $tbe_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="tbe_lr" id="tbe_lr3" <?php if(in_array(3,
                                                                        $tbe_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="tbe_lr" id="tbe_lr2" <?php if(in_array(2,
                                                                        $tbe_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="tbe_lr" id="tbe_lr1" <?php if(in_array(1,
                                                                        $tbe_lr)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label left">
                                                                    L
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="tbe_ll" id="tbe_ll1" <?php if(in_array(1,
                                                                        $tbe_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="tbe_ll" id="tbe_ll2" <?php if(in_array(2,
                                                                        $tbe_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="tbe_ll" id="tbe_ll3" <?php if(in_array(3,
                                                                        $tbe_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="tbe_ll" id="tbe_ll4" <?php if(in_array(4,
                                                                        $tbe_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="tbe_ll" id="tbe_ll5" <?php if(in_array(5,
                                                                        $tbe_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="tbe_ll" id="tbe_ll6" <?php if(in_array(6,
                                                                        $tbe_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="tbe_ll" id="tbe_ll7" <?php if(in_array(7,
                                                                        $tbe_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="tbe_ll" id="tbe_ll8" <?php if(in_array(8,
                                                                        $tbe_ll)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    L
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" id="occlusal_plan1" type="checkbox"
                                                    name="occlusal_plan" value="maintain" <?php if($patient->occlusal_plane
                                                == 'maintain'): ?> checked <?php endif; ?> />
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" id="occlusal_plan2" type="checkbox"
                                                    name="occlusal_plan" value="correct" <?php if($patient->occlusal_plane
                                                == 'correct'): ?> checked <?php endif; ?> />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="occlusal_plane_notes"
                                                ...
                                                placeholder="Leveling as needed"><?php echo e($patient->occlusal_plane_notes); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <?php
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" id="additional_attachments3" name="additional_attachments" type="checkbox" value="Bite Keeper" <?php if(in_array("Bite Keeper", $additional_attachments)): ?> checked <?php endif; ?> />
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" id="additional_attachments4" name="additional_attachments" type="checkbox" value="Secret Wings" <?php if(in_array("Secret Wings", $additional_attachments)): ?> checked <?php endif; ?> />
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="add_pontic_ur" id="add_pontic_ur8" <?php if(in_array(8,
                                                                        $add_pontic_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="add_pontic_ur" id="add_pontic_ur7" <?php if(in_array(7,
                                                                        $add_pontic_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="add_pontic_ur" id="add_pontic_ur6" <?php if(in_array(6,
                                                                        $add_pontic_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="add_pontic_ur" id="add_pontic_ur5" <?php if(in_array(5,
                                                                        $add_pontic_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="add_pontic_ur" id="add_pontic_ur4" <?php if(in_array(4,
                                                                        $add_pontic_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="add_pontic_ur" id="add_pontic_ur3" <?php if(in_array(3,
                                                                        $add_pontic_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="add_pontic_ur" id="add_pontic_ur2" <?php if(in_array(2,
                                                                        $add_pontic_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="add_pontic_ur" id="add_pontic_ur1" <?php if(in_array(1,
                                                                        $add_pontic_ur)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="add_pontic_ul" id="add_pontic_ul1" <?php if(in_array(1,
                                                                        $add_pontic_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="add_pontic_ul" id="add_pontic_ul2" <?php if(in_array(2,
                                                                        $add_pontic_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="add_pontic_ul" id="add_pontic_ul3" <?php if(in_array(3,
                                                                        $add_pontic_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="add_pontic_ul" id="add_pontic_ul4" <?php if(in_array(4,
                                                                        $add_pontic_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="add_pontic_ul" id="add_pontic_ul5" <?php if(in_array(5,
                                                                        $add_pontic_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="add_pontic_ul" id="add_pontic_ul6" <?php if(in_array(6,
                                                                        $add_pontic_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="add_pontic_ul" id="add_pontic_ul7" <?php if(in_array(7,
                                                                        $add_pontic_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="add_pontic_ul" id="add_pontic_ul8" <?php if(in_array(8,
                                                                        $add_pontic_ul)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    U
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="add_pontic_lr" id="add_pontic_lr8" <?php if(in_array(8,
                                                                        $add_pontic_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="add_pontic_lr" id="add_pontic_lr7" <?php if(in_array(7,
                                                                        $add_pontic_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="add_pontic_lr" id="add_pontic_lr6" <?php if(in_array(6,
                                                                        $add_pontic_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="add_pontic_lr" id="add_pontic_lr5" <?php if(in_array(5,
                                                                        $add_pontic_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="add_pontic_lr" id="add_pontic_lr4" <?php if(in_array(4,
                                                                        $add_pontic_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="add_pontic_lr" id="add_pontic_lr3" <?php if(in_array(3,
                                                                        $add_pontic_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="add_pontic_lr" id="add_pontic_lr2" <?php if(in_array(2,
                                                                        $add_pontic_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="add_pontic_lr" id="add_pontic_lr1" <?php if(in_array(1,
                                                                        $add_pontic_lr)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label left">
                                                                    L
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="add_pontic_ll" id="add_pontic_ll1" <?php if(in_array(1,
                                                                        $add_pontic_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="add_pontic_ll" id="add_pontic_ll2" <?php if(in_array(2,
                                                                        $add_pontic_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="add_pontic_ll" id="add_pontic_ll3" <?php if(in_array(3,
                                                                        $add_pontic_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="add_pontic_ll" id="add_pontic_ll4" <?php if(in_array(4,
                                                                        $add_pontic_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="add_pontic_ll" id="add_pontic_ll5" <?php if(in_array(5,
                                                                        $add_pontic_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="add_pontic_ll" id="add_pontic_ll6" <?php if(in_array(6,
                                                                        $add_pontic_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="add_pontic_ll" id="add_pontic_ll7" <?php if(in_array(7,
                                                                        $add_pontic_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="add_pontic_ll" id="add_pontic_ll8" <?php if(in_array(8,
                                                                        $add_pontic_ll)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    L
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="add_bite_turbos_ur" id="add_bite_turbos_ur8" <?php if(in_array(8,
                                                                        $add_bite_turbos_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="add_bite_turbos_ur" id="add_bite_turbos_ur7" <?php if(in_array(7,
                                                                        $add_bite_turbos_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="add_bite_turbos_ur" id="add_bite_turbos_ur6" <?php if(in_array(6,
                                                                        $add_bite_turbos_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="add_bite_turbos_ur" id="add_bite_turbos_ur5" <?php if(in_array(5,
                                                                        $add_bite_turbos_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="add_bite_turbos_ur" id="add_bite_turbos_ur4" <?php if(in_array(4,
                                                                        $add_bite_turbos_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="add_bite_turbos_ur" id="add_bite_turbos_ur3" <?php if(in_array(3,
                                                                        $add_bite_turbos_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="add_bite_turbos_ur" id="add_bite_turbos_ur2" <?php if(in_array(2,
                                                                        $add_bite_turbos_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="add_bite_turbos_ur" id="add_bite_turbos_ur1" <?php if(in_array(1,
                                                                        $add_bite_turbos_ur)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="add_bite_turbos_ul" id="add_bite_turbos_ul1" <?php if(in_array(1,
                                                                        $add_bite_turbos_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="add_bite_turbos_ul" id="add_bite_turbos_ul2" <?php if(in_array(2,
                                                                        $add_bite_turbos_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="add_bite_turbos_ul" id="add_bite_turbos_ul3" <?php if(in_array(3,
                                                                        $add_bite_turbos_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="add_bite_turbos_ul" id="add_bite_turbos_ul4" <?php if(in_array(4,
                                                                        $add_bite_turbos_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="add_bite_turbos_ul" id="add_bite_turbos_ul5" <?php if(in_array(5,
                                                                        $add_bite_turbos_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="add_bite_turbos_ul" id="add_bite_turbos_ul6" <?php if(in_array(6,
                                                                        $add_bite_turbos_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="add_bite_turbos_ul" id="add_bite_turbos_ul7" <?php if(in_array(7,
                                                                        $add_bite_turbos_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="add_bite_turbos_ul" id="add_bite_turbos_ul8" <?php if(in_array(8,
                                                                        $add_bite_turbos_ul)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    U
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="add_bite_turbos_lr" id="add_bite_turbos_lr8" <?php if(in_array(8,
                                                                        $add_bite_turbos_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="add_bite_turbos_lr" id="add_bite_turbos_lr7" <?php if(in_array(7,
                                                                        $add_bite_turbos_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="add_bite_turbos_lr" id="add_bite_turbos_lr6" <?php if(in_array(6,
                                                                        $add_bite_turbos_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="add_bite_turbos_lr" id="add_bite_turbos_lr5" <?php if(in_array(5,
                                                                        $add_bite_turbos_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="add_bite_turbos_lr" id="add_bite_turbos_lr4" <?php if(in_array(4,
                                                                        $add_bite_turbos_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="add_bite_turbos_lr" id="add_bite_turbos_lr3" <?php if(in_array(3,
                                                                        $add_bite_turbos_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="add_bite_turbos_lr" id="add_bite_turbos_lr2" <?php if(in_array(2,
                                                                        $add_bite_turbos_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="add_bite_turbos_lr" id="add_bite_turbos_lr1" <?php if(in_array(1,
                                                                        $add_bite_turbos_lr)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label left">
                                                                    L
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="add_bite_turbos_ll" id="add_bite_turbos_ll1" <?php if(in_array(1,
                                                                        $add_bite_turbos_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="add_bite_turbos_ll" id="add_bite_turbos_ll2" <?php if(in_array(2,
                                                                        $add_bite_turbos_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="add_bite_turbos_ll" id="add_bite_turbos_ll3" <?php if(in_array(3,
                                                                        $add_bite_turbos_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="add_bite_turbos_ll" id="add_bite_turbos_ll4" <?php if(in_array(4,
                                                                        $add_bite_turbos_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="add_bite_turbos_ll" id="add_bite_turbos_ll5" <?php if(in_array(5,
                                                                        $add_bite_turbos_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="add_bite_turbos_ll" id="add_bite_turbos_ll6" <?php if(in_array(6,
                                                                        $add_bite_turbos_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="add_bite_turbos_ll" id="add_bite_turbos_ll7" <?php if(in_array(7,
                                                                        $add_bite_turbos_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="add_bite_turbos_ll" id="add_bite_turbos_ll8" <?php if(in_array(8,
                                                                        $add_bite_turbos_ll)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    L
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="additional_attachments_notes"
                                                ...
                                                placeholder="Notes"><?php echo e(@$patient->additional_attachments_notes); ?></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" id="keep_already_placed_attachments"
                                                    ...
                                                    <?php if($patient->keep_already_placed_attachments == 1): ?> checked <?php endif; ?>
                                                    <?php if($mode == 'add'): ?> checked <?php endif; ?>
                                                />
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select id="trim_type_upper" name="trim_type_upper"
                                                    class="form-control">
                                                    <option value="Straight" <?php if($patient->trim_type_upper ==
                                                        'Straight'): ?> selected <?php endif; ?>>Straight
                                                    </option>
                                                    <option value="Scalloped" <?php if($patient->trim_type_upper ==
                                                        'Scalloped'): ?> selected <?php endif; ?>>Scalloped
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select id="trim_type_lower" name="trim_type_lower"
                                                    class="form-control">
                                                    <option value="Straight" <?php if($patient->trim_type_lower ==
                                                        'Straight'): ?> selected <?php endif; ?>>Straight
                                                    </option>
                                                    <option value="Scalloped" <?php if($patient->trim_type_lower ==
                                                        'Scalloped'): ?> selected <?php endif; ?>>Scalloped
                                                    </option>
                                                </select>
                                            </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="tla_ur" id="tla_ur8" <?php if(in_array(8,
                                                                        $tla_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="tla_ur" id="tla_ur7" <?php if(in_array(7,
                                                                        $tla_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="tla_ur" id="tla_ur6" <?php if(in_array(6,
                                                                        $tla_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="tla_ur" id="tla_ur5" <?php if(in_array(5,
                                                                        $tla_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="tla_ur" id="tla_ur4" <?php if(in_array(4,
                                                                        $tla_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="tla_ur" id="tla_ur3" <?php if(in_array(3,
                                                                        $tla_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="tla_ur" id="tla_ur2" <?php if(in_array(2,
                                                                        $tla_ur)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="tla_ur" id="tla_ur1" <?php if(in_array(1,
                                                                        $tla_ur)): ?> checked <?php endif; ?>>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="tla_ul" id="tla_ul1" <?php if(in_array(1,
                                                                        $tla_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="tla_ul" id="tla_ul2" <?php if(in_array(2,
                                                                        $tla_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="tla_ul" id="tla_ul3" <?php if(in_array(3,
                                                                        $tla_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="tla_ul" id="tla_ul4" <?php if(in_array(4,
                                                                        $tla_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="tla_ul" id="tla_ul5" <?php if(in_array(5,
                                                                        $tla_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="tla_ul" id="tla_ul6" <?php if(in_array(6,
                                                                        $tla_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="tla_ul" id="tla_ul7" <?php if(in_array(7,
                                                                        $tla_ul)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="tla_ul" id="tla_ul8" <?php if(in_array(8,
                                                                        $tla_ul)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    U
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="tla_lr" id="tla_lr8" <?php if(in_array(8,
                                                                        $tla_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="tla_lr" id="tla_lr7" <?php if(in_array(7,
                                                                        $tla_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="tla_lr" id="tla_lr6" <?php if(in_array(6,
                                                                        $tla_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="tla_lr" id="tla_lr5" <?php if(in_array(5,
                                                                        $tla_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="tla_lr" id="tla_lr4" <?php if(in_array(4,
                                                                        $tla_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="tla_lr" id="tla_lr3" <?php if(in_array(3,
                                                                        $tla_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="tla_lr" id="tla_lr2" <?php if(in_array(2,
                                                                        $tla_lr)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="tla_lr" id="tla_lr1" <?php if(in_array(1,
                                                                        $tla_lr)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label left">
                                                                    L
                                                        ...
                                                        <div class="teeth-wrapper">
                                                            <div class="card border-0">
                                                                <div
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" class="tooth" data-number="1"
                                                                        name="tla_ll" id="tla_ll1" <?php if(in_array(1,
                                                                        $tla_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="2"
                                                                        name="tla_ll" id="tla_ll2" <?php if(in_array(2,
                                                                        $tla_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="3"
                                                                        name="tla_ll" id="tla_ll3" <?php if(in_array(3,
                                                                        $tla_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="4"
                                                                        name="tla_ll" id="tla_ll4" <?php if(in_array(4,
                                                                        $tla_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="5"
                                                                        name="tla_ll" id="tla_ll5" <?php if(in_array(5,
                                                                        $tla_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="6"
                                                                        name="tla_ll" id="tla_ll6" <?php if(in_array(6,
                                                                        $tla_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="7"
                                                                        name="tla_ll" id="tla_ll7" <?php if(in_array(7,
                                                                        $tla_ll)): ?> checked <?php endif; ?>>
                                                                    <input type="checkbox" class="tooth" data-number="8"
                                                                        name="tla_ll" id="tla_ll8" <?php if(in_array(8,
                                                                        $tla_ll)): ?> checked <?php endif; ?>>
                                                                </div>
                                                                <div class="side-label right">
                                                                    L
                        ...
                        <div class="mb-3 text-end">
                            ...
                            <button class="btn btn-primary btn-sm waves-effect waves-light px-3" id="submit-prescription"
                                <?php if(($patient->treat_upper_arch == 1 || $patient->treat_lower_arch == 1) &&
                    ...
                    <div class="tab-pane fade" id="pill-tab-div6" role="tabpanel" aria-labelledby="pill-tab-li6">
                        ...
                        <div class="mb-3 notifications" <?php if($fn1==1 && $fn2==1 && $fn3==1 && $fn4==1): ?>
                        ...
                        <div class="mb-3 finish" <?php if($fn1==0 || $fn2==0 || $fn3==0 || $fn4==0): ?> style="display: none;"
                            <?php endif; ?>>
...
<script>
    ...
    var link_regex =
      ...
      window.history.pushState({}, '', newUrl);
                ...
                <?php if(@$_GET['tab']): ?>
                fetchOverview()
                 $('ul.nav-pills a[href="#<?php echo e($_GET['tab']); ?>"]').tab('show');
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app_base_horizontal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u531876341/domains/secretalign-user.com/public_html/resources/views/patients/add_patient.blade.php ENDPATH**/ ?>