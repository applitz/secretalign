                                    ...
                                    <div class="col-12 position-relative">
                                        <select class="form-select form-select-sm mySelect2" id="statuDoctor" data-options='{"removeItemButton":true,"placeholder":true}'
                                            ...
                                            <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($doctor->id); ?>" <?php echo e(request('ft_doctor') == $doctor->id ? 'selected' : ''); ?>>
                                                <?php echo e(ucfirst($doctor->user_full_name)); ?>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script src="<?php echo e(asset('public/assets/customjs/home-staff.js')); ?>"></script>
    <script>
...
<?php echo $__env->make('layouts.app_base_horizontal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u531876341/domains/secretalign-user.com/public_html/resources/views/staff/home.blade.php ENDPATH**/ ?>