                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <div class="col-12 position-relative">
                                    <select class="form-select form-select-sm mySelect2" id="ft_doctor" style="border: 1px solid #aaa;"
                                        ...
                                        <option value="<?php echo e($doctor->id); ?>" <?php echo e(request('doctor') == $doctor->id ? 'selected' : ''); ?>>
                                            <?php echo e($doctor->user_full_name); ?>
...
<script src="<?php echo e(asset('public/assets/customjs/staff/patients.js')); ?>"></script>
<script>
...
<?php echo $__env->make('layouts.app_base_horizontal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u531876341/domains/secretalign-user.com/public_html/resources/views/staff/patients/index.blade.php ENDPATH**/ ?>