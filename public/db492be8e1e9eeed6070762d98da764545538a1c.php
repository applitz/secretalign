...
<div class="tab-pane fade <?php echo e($baseUrl !== null && $code !== null ? 'show active' : ''); ?> " id="pill-tab-div2" role="tabpanel">
    ...
    <div class="mb-3 ">
        ...
        >
            ...
            <a class="btn btn-primary order-from-button"  style="display: none" href="javascript:void(0);" id="select-from-shining3d-link" data-shining3d-user-id="<?php echo e(Auth::user()->shining3d_user_id); ?>" data-shining3d-access-token="<?php echo e(Auth::user()->shining3d_access_token); ?>" >
                <div class="d-flex align-items-center justify-content-center">
