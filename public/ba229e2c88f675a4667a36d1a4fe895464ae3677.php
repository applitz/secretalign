    ...
    <div class="col-md-12">
        <div class="card mb-3">
            <div class="card-body py-4" id="card-body-for-iframe">
                ...
                <p><strong>Date of Birth:</strong> <?php echo e($patient->dob); ?></p>
                <p><strong>Treatment Type:</strong> <?php echo e($patient->treatment_type == 1 ? 'Treatment Plan Service' : 'Aligners Full-Service'); ?></p>
                <?php if($patient->fl_upper_arch && $patient->fl_lower_arch && $patient->is_treatment_submitted == 0 && !@$patient->iframe_link): ?>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="btn-group float-end btns-steps" role="group"
                                    ...
                                    <input data-maxillary="<?php echo $upper_arch_stl; ?>" data-mandibular="<?php echo $lower_arch_stl; ?>"
                                        ...
                                        id="step-<?php echo e($step); ?>" autocomplete="off">
                ...
                <?php if(@$patient->iframe_link): ?>
                    ...
                    <!--<div class="row mt-5">-->
                    <!--        <div class="col-md-12">-->
                    <!--            <a href="<?php echo e(route('iframe', request()->phase)); ?>" class="btn btn-primary"-->
...
<?php /**PATH /home/u531876341/domains/secretalign-user.com/public_html/resources/views/patients/case-overview/card_body_for_iframe.blade.php ENDPATH**/ ?>