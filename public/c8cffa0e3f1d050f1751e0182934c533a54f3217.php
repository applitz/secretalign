...
<div class="card shadow-lg">
              <div class="card-body">
                <div class="d-flex">
                  <div class="pe-3"><img src="<?php echo e(asset('public/dashboard')); ?>/assets/img/icons/cookie-1.png" width="40" alt="cookie"></div>
                  <div>
                    <p><?php echo trans('cookie-consent::texts.message'); ?></p>
...
<?php /**PATH D:\xampp\htdocs\secretalign\resources\views/vendor/cookie-consent/dialogContents.blade.php ENDPATH**/ ?>